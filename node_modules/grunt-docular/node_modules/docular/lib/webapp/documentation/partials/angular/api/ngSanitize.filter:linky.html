...
<ul class="parameters"><li><code class="plain">text – {string} – </code>
<p>Input text.</p></li>
<li><code class="plain">target – {string} – </code>
...
<div source-edit="ngSanitize" source-edit-deps="angular.js script.js" source-edit-html="index.html-168" source-edit-css="" source-edit-js="script.js-167" source-edit-unit="" source-edit-scenario="scenario.js-169"></div>
...
<div class="well doc-example-live" ng-embed-app="ngSanitize" ng-set-html="index.html-168" ng-eval-javascript="script.js-167"></div></div>
</div>
