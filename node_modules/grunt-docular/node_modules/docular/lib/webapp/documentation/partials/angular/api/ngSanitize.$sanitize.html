...
<ul class="parameters"><li><code class="plain">html – {string} – </code>
<p>Html input.</p></li>
</ul>
...
<div source-edit="ngSanitize" source-edit-deps="angular.js script.js" source-edit-html="index.html-171" source-edit-css="" source-edit-js="script.js-170" source-edit-unit="" source-edit-scenario="scenario.js-172"></div>
<div class="tabbable"><div class="tab-pane" title="index.html">
<pre class="prettyprint linenums" ng-set-text="index.html-171" ng-html-wrap="ngSanitize angular.js script.js"></pre>
...
<div class="well doc-example-live" ng-embed-app="ngSanitize" ng-set-html="index.html-171" ng-eval-javascript="script.js-170"></div></div>
</div>
