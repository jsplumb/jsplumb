...
To solve this problem, we introduce the  <code class="plain">ngDisabled</code>  directive.</p></div>
<h2 id="Usage">Usage</h2>
<div class="usage">as attribute<pre class="prettyprint linenums">&lt;INPUT ng-disabled="{expression}"&gt;
   ...
&lt;/INPUT&gt;</pre>
<h3 id="Parameters">Parameters</h3>
<ul class="parameters"><li><code class="plain">ngDisabled – {expression} – </code>
<p>Angular expression that will be evaluated.</p></li>
</ul>
</div>
<h2 id="Example">Example</h2>
<div class="example"><h4>Source</h4>
<div source-edit="" source-edit-deps="angular.js" source-edit-html="index.html-66" source-edit-css="" source-edit-js="" source-edit-unit="" source-edit-scenario="scenario.js-67"></div>
<div class="tabbable"><div class="tab-pane" title="index.html">
<pre class="prettyprint linenums" ng-set-text="index.html-66" ng-html-wrap=" angular.js"></pre>
...
<div class="well doc-example-live" ng-embed-app="" ng-set-html="index.html-66" ng-eval-javascript=""></div></div>
</div>
