<h1><code ng:non-bindable="">HTML Compiler</code>
<span class="hint"></span>
</h1>
<div><h1 id="overview">Overview</h2>

<p>Angular's <a href="documentation/angular/api/ng.$compile"><code>HTML compiler</code></a> allows the developer to teach the
browser new HTML syntax. The compiler allows you to attach behavior to any HTML element or attribute
and even create new HTML element or attributes with custom behavior. Angular calls these behavior
extensions <a href="documentation/angular/api/ng.$compileProvider#directive"><code>directives</code></a>.</p>
...
center needs to be aligned with the text's center. Simply add  <code class="plain">align="center"</code>  attribute to any
...
<p>Some directives such <a href="documentation/angular/api/ng.directive:ngRepeat"><code> <code class="plain">ng-repeat</code> </code></a> clone DOM elements once for each item in collection. Having a compile and link phase
...
well as comments. Here are some equivalent examples of invoking the <a href="documentation/angular/api/ng.directive:ngBind"><code> <code class="plain">ng-bind</code> </code></a> directive.</p>
...
<p>A directive is just a function which executes when the compiler encounters it in the DOM. See <a href="documentation/angular/api/ng.$compileProvider#directive"><code>directive API</code></a> for in-depth documentation on how
to write directives.</p>

<p>Here is a directive which makes any element draggable. Notice the  <code class="plain">draggable</code>  attribute on the
 <code class="plain"><span></code>  element.</p>

<h3>Source</h3>
<div source-edit="drag" source-edit-deps="angular.js script.js" source-edit-html="index.html-12" source-edit-css="" source-edit-js="script.js-11" source-edit-unit="" source-edit-scenario=""></div>
<div class="tabbable"><div class="tab-pane" title="index.html">
<pre class="prettyprint linenums" ng-set-text="index.html-12" ng-html-wrap="drag angular.js script.js"></pre>
...
<div class="well doc-example-live" ng-embed-app="drag" ng-set-html="index.html-12" ng-eval-javascript="script.js-11"></div>

<p>The presence of the  <code class="plain">draggable</code>  attribute on any element gives the element new behavior. The beauty of
...
combine it with data, resulting in a new string. The resulting text is then  <code class="plain">innerHTML</code> ed into
an element.</p>
...
<p>This means that any changes to the data need to be re-merged with the template and then
 <code class="plain">innerHTML</code> ed into the DOM. Some of the issues with this approach are: reading user input and merging it with data,
...
the view. And because no  <code class="plain">innerHTML</code>  is used there are no issues of clobbering user input.
