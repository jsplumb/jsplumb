...
<ul class="dependencies"><li><code ng:non-bindable=""><a href="documentation/angular/api/$window">$window</a></code>
</li>
</ul>
...
<div source-edit="" source-edit-deps="angular.js script.js" source-edit-html="index.html-153" source-edit-css="" source-edit-js="script.js-152" source-edit-unit="" source-edit-scenario=""></div>
<div class="tabbable"><div class="tab-pane" title="index.html">
<pre class="prettyprint linenums" ng-set-text="index.html-153" ng-html-wrap=" angular.js script.js"></pre>
...
<pre class="prettyprint linenums" ng-set-text="script.js-152"></pre>
<script type="text/ng-template" id="script.js-152">
...
<div class="well doc-example-live" ng-embed-app="" ng-set-html="index.html-153" ng-eval-javascript="script.js-152"></div></div>
</div>
