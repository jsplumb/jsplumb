...
<ul class="parameters"><li><code class="plain">ngInclude|src – {string} – </code>
<p>angular expression evaluating to URL. If the source is a string constant,
make sure you wrap it in quotes, e.g.  <code class="plain">src="'myPartialTemplate.html'"</code> .</p></li>
<li><code class="plain">onload<i>(optional)</i> – {string=} – </code>
<p>Expression to evaluate when a new partial is loaded.</p></li>
<li><code class="plain">autoscroll<i>(optional)</i> – {string=} – </code>
<p>Whether  <code class="plain">ngInclude</code>  should call <a href="documentation/angular/api/ng.$anchorScroll"><code>$anchorScroll</code></a> to scroll the viewport after the content is loaded.</p>
...
<div source-edit="" source-edit-deps="angular.js script.js" source-edit-html="index.html-110 template1.html template2.html" source-edit-css="animations.css" source-edit-js="script.js-111" source-edit-unit="" source-edit-scenario="scenario.js-112"></div>
...
<div class="well doc-example-live" ng-embed-app="" ng-set-html="index.html-110" ng-eval-javascript="script.js-111"></div></div>
</div>
