...
import {createElementNS, jsPlumbDOMElement} from ".."
...
export function _node(instance:jsPlumbInstance, name:string, attributes?:ElementAttributes):jsPlumbDOMElement {
