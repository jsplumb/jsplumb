jsPlumb.ready(function() {    
    ...
    j3.bind("connection", function(info, originalEvent) {
        updateConnections(info.connection);
    });
    j3.bind("connectionDetached", function(info, originalEvent) {
    ...
    var e1 = j3.addEndpoint('w3_1', { anchor:[0.5, 1, 0, 1] }, exampleEndpoint2);
    ...
    var e1 = j3.addEndpoint("w3_1", { anchor:anchors }, exampleEndpoint);
    ...
    var e2 = j3.addEndpoint('w3_2', { anchor:[0.5, 1, 0, 1] }, exampleEndpoint);
    ...
    j3.addEndpoint('w3_2', { anchor:"RightMiddle" }, exampleEndpoint2);

    var e3 = j3.addEndpoint("w3_3", { anchor:[0.25, 0, 0, -1] }, exampleEndpoint);
    e3.bind("maxConnections", maxConnectionsCallback);
    j3.addEndpoint("w3_3", { anchor:[0.75, 0, 0, -1] }, exampleEndpoint2);

    var e4 = j3.addEndpoint("w3_4", { anchor:[1, 0.5, 1, 0] }, exampleEndpoint);
    e4.bind("maxConnections", maxConnectionsCallback);			
    j3.addEndpoint("w3_4", { anchor:[0.25, 0, 0, -1] }, exampleEndpoint2);

    // make .window divs draggable
    var windows = jsPlumb.getSelector("#demo3 .window");
    j3.draggable(windows, {containment:"parent"});

    // add endpoint of type 3 using a selector. 
    j3.addEndpoint(windows, exampleEndpoint3);
