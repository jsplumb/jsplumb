;(function() {
	...
	jsPlumb.ready(function() {
			...
			instance.draggable($(".drag-drop-demo .window"));

			// add endpoint of type 3 using a selector. 
			instance.addEndpoint($(".drag-drop-demo .window"), exampleEndpoint3);

			//			
			if (!_initialised) {
				$(".hide").click(function() {
					instance.toggleVisible($(this).attr("rel"));
				});
	
				$(".drag").click(function() {
					var s = instance.toggleDraggable($(this).attr("rel"));
				...
				$(".detach").click(function() {
					instance.detachAllConnections($(this).attr("rel"));
				});
